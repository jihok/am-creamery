class Employee < ActiveRecord::Base
  ...
  accepts_nested_attributes_for :assignments, :reject_if => lambda{|assignment| assignment[:employee_id].blank?}
  ...
  def recent_hours
    hours = 0
    self.current_assignment.shifts.completed.for_past_days(14).each do |x|
